...
class MainActivity : AppCompatActivity() {
    ...
    private fun getRecommendedDestinations(): List<Destination> {
        return listOf(
            ...
            Destination("Dusun Bambu", "Tempat rekreasi alam dengan berbagai aktivitas keluarga", "https://cdn.idntimes.com/content-images/community/2022/07/20220727-151225-329ae2b286ff7799fbbec7d4597d307a-98260cd14596464f8a1ad78806bb8629.jpg", -6.759, 107.596, "http://www.dusunbambu.id/"),
    ...
    private fun getPopularDestinations(): List<Destination> {
        return listOf(
            ...
            Destination("Trans Studio Bandung", "Taman hiburan indoor terbesar di Indonesia", "https://ik.imagekit.io/tvlk/blog/2020/01/Wisata-Keluarga-Bandung-5-Traveloka.jpeg", -6.926, 107.634, "https://example.com/transstudio"),
